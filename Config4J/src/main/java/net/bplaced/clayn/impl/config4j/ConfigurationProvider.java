...
import net.bplaced.clayn.impl.config4j.impl.io.SimpleConfigurationFactory;
...
public interface ConfigurationProvider {
     ...
     */
    public static ConfigurationProvider newFileBasedProvider(File configFile, ConfigurationFactory factory) {
    ...
    public static ConfigurationProvider newFileBasedProvider(File configFile) {
